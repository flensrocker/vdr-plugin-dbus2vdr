...
OBJS = $(PLUGIN).o channel.o connection.o epg.o helper.o network.o object.o osd.o plugin.o recording.o remote.o setup.o shutdown.o skin.o status.o timer.o upstart.o vdr.o
