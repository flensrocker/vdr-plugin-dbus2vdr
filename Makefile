...
OBJS = $(PLUGIN).o bus.o channel.o connection.o epg.o helper.o message.o monitor.o object.o osd.o plugin.o recording.o remote.o setup.o shutdown.o skin.o status.o timer.o upstart.o vdr.o
