...
namespace cDBusChannelsHelper
{
  ...
  static void Count(GVariant *Parameters, GDBusMethodInvocation *Invocation)
  {
    g_dbus_method_invocation_return_value(Invocation, g_variant_new("(i)", Channels.Count()));
  }

  static void GetFromTo(GVariant *Parameters, GDBusMethodInvocation *Invocation)
  {
    gint32 from_index = -1;
    gint32 to_index = -1;
  ...
  static void List(GVariant *Parameters, GDBusMethodInvocation *Invocation)
  {
